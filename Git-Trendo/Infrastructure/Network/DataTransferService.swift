...
extension DefaultDataTransferService: DataTransferService {
    ...
    public func request<T: Decodable, E: ResponseRequestable>(with endpoint: E,
        ...
        return self.networkService.request(endpoint: endpoint, loadFromCache: loadFromCache) { result in
            switch result {
    ...
    public func request<E>(with endpoint: E, loadFromCache: Bool, completion: @escaping CompletionHandler<Void>) -> NetworkCancellable? where E : ResponseRequestable, E.Response == Void {
        return self.networkService.request(endpoint: endpoint, loadFromCache: loadFromCache) { result in
            switch result {
            case .success:
